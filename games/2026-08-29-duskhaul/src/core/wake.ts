 ...
 *
 * ## The wedge this replaces (reproduced on seed 7, 420 actions)
 * `main.ts` used to do, inline:
 *
 * ```ts
 * document.addEventListener('visibilitychange', () => {
 ...
 * ```
 *
 * That is the exact signature the hardened fuzz reports as
 * "game loop wedged — loop.time frozen for 3s (hidden=false)".
 *
 * ## The rule
