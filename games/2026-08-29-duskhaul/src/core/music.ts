 ...
 * cost ONE decode and ONE buffer. A 174s stem decodes to ~33 MB at the
 * context rate regardless of how well the file compresses, so a track-keyed
 * cache would hold a second identical copy the moment the same score is used
 * for both the menu and the run.
 */
