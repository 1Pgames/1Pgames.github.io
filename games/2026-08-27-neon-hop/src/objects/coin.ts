 ...
 * currency instead of XP, and plays the (previously unused) `ANIM.coin`
 * sheet. Elites drop several of these instead of one lump sum so a kill
 * reads as a small reward burst.
 *
