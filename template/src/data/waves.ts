import type { RunPhase, WaveSpec } from '../core/run';
...
export const PHASES: readonly RunPhase[] = [
  ...
  { name: 'Pressure', fromSeconds: 240, difficultyMul: 1.7 },
  { name: 'Climax', fromSeconds: 360, difficultyMul: 2.2 },
  { name: 'Finale', fromSeconds: 450, difficultyMul: 2.6 },
] as const;
...
export const WAVES: readonly WaveSpec[] = [
  ...
  { at: 4, until: 120, spawns: [{ id: 'swarm', count: 0, everyMs: 900 }] },
  { at: 120, until: 240, spawns: [{ id: 'swarm', count: 0, everyMs: 550 }, { id: 'runner', count: 0, everyMs: 3000 }] },
  { at: 240, until: 360, spawns: [{ id: 'swarm', count: 0, everyMs: 380 }, { id: 'runner', count: 0, everyMs: 2200 }] },
  { at: 360, until: 480, spawns: [{ id: 'swarm', count: 0, everyMs: 280 }, { id: 'runner', count: 0, everyMs: 1600 }] },

  // --- Opening (0-120s): learn to move and hit things ------------------
  { at: 4, spawns: [{ id: 'swarm', count: 6, everyMs: 400 }] },
  { at: 20, spawns: [{ id: 'swarm', count: 8, everyMs: 350 }] },
  ...
  },
  {
    at: 390,
    spawns: [
      { id: 'runner', count: 12, everyMs: 320 },
      { id: 'swarm', count: 18, everyMs: 240 },
    ],
  },
  {
    at: 420,
    spawns: [
      { id: 'elite', count: 1 },
      { id: 'shooter', count: 8, everyMs: 450 },
      { id: 'healer', count: 4, everyMs: 800 },
    ],
  },
